...
def spawn_ball(direction):
    ...
    ball_vel[0] = random.randrange(120, 240) / 60.0 # position the ball at the centre of the canvas
    ball_vel[1] = -random.randrange(60, 180) / 60.0 # position the ball at the centre of the canvas
    ball_pos[0] = WIDTH / 2
    ball_pos[1] = HEIGHT / 2
    if direction == False:
